...
function Chirurgiens() {
  return (
    ...
    <div className="flex flex-col ml-16">
      ...
      <div className="ml-36 w-fit h-fit px-3 py-1.5 bg-blue-500 rounded flex justify-center items-center font-bold -mt-1.5">
        <h2 className="text-white text-xl">Nos chirurgiens esthétiques</h2>
      </div>
  
      <p className="my-5 px-32">
      ...
      <div className="flex gap-8 px-32 pt-10 justify-center items-center">
        ...
        <div className="bg-white rounded-xl shadow-md p-4 py-5 w-64 h-fit text-center">
          ...
          <button className="w-fit h-fit px-1.5 py-1.5 bg-blue-500 hover:bg-pink-200 rounded flex justify-self-center items-center font-bold mt-2 text-white">Voir CV </button>
        </div>
