...
<div className="relative w-full overflow-hidden">
      ...
      <div
        ...
        className={`flex  overflow-x-scroll scroll-smooth p-8 cursor-${isDragging ? 'grabbing' : 'grab'} pl-[10vw] `}
        ...
        {articles.map((article, index) => (
          ...
          <span key={i}>{line} <br /></span>
              ...
              <div className="flex gap-4">
                <button className="bg-blue-500 text-white px-3 py-0.5 rounded-4xl font-bold">
                  + infos
                </button>
                <button className="bg-blue-500 text-white px-3 py-0.5 rounded-4xl font-bold">
            ...
            <div className="w-1/2 flex justify-end">
              <img  src={article.image} alt={article.title} draggable={false}   className="select-none w-[300px] h-[250px] object-cover p-3.5" />
            </div>
          </article>
        ))}
      </div>
